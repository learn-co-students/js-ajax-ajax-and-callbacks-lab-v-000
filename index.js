...
function searchRepositories() {
    ...
    $.get(`${mainURL}/search/repositories?q=${searchTerms}`, function(data) {
...
function showCommits(el) {
    ...
    $.get(`${mainURL}/repos/${owner}/${repoName}/commits`, function(data) {
    ...
    const repoList = "<ul>" + repos.map(repo => {
        return (`
            <li>
                ...
                <p><a href="#" data-repository="${repo.name}" data-owner="${repo.owner.login}" onclick="getCommits(this)">Show Commits</a></p>
